...
public class LoginActivity extends AppCompatActivity  {
    ...
    private LoginActivity.SessionCallback sessionCallback = new LoginActivity.SessionCallback();
    Session session;
                        ...
                        public void onSuccess(MeV2Response result) {
                            ...
                            if (kakaoAccount != null) {
                                ...
                                if (profile != null) {
                                    ...
                                    Toast.makeText(LoginActivity.this,  profile.getNickname() + "로그인 되었습니다.", Toast.LENGTH_SHORT).show();
